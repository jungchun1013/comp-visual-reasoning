...
- [ ] [ablation] E3: SigLIP decoder1l patching — queued in night pipeline after E4 RSA (running 07:03–). Harvest verdict: analogous late-layer GCA head? → A4.3
- [ ] [data] E8: raw-backbone probes ×4 — last pipeline stage. Harvest verdict → A1.2
- [ ] [metrics] E4 harvest when RSA lands: GCA-decoder probe/RSA stage-transition layers vs patching heads (A2↔A4 lock)
- [ ] [plot] E9 contrast figure (table+json done); E10 residue: grounding_manipulation replot needs GPU (labels already v2 in code)
